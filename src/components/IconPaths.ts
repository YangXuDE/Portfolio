...
export const iconPaths = {
	...
	// 相机 (Camera)
	camera: `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M208 56H180.3L166.7 35.6A8 8 0 0 0 160 32H96a8 8 0 0 0-6.7 3.6L75.7 56H48A24 24 0 0 0 24 80v112a24 24 0 0 0 24 24h160a24 24 0 0 0 24-24V80a24 24 0 0 0-24-24Zm-80 136a44 44 0 1 1 44-44 44 44 0 0 1-44 44Z"/><circle cx="128" cy="132" r="28" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/>`,
	
	// 二次元/游戏 (Anime/Game)
	anime: `<path fill="currentColor" stroke="none" d="M232,96a79.8,79.8,0,0,0-23.77-56.91A8,8,0,0,0,200,38.65l-26.65,5.33A79.4,79.4,0,0,0,128,32h0A79.4,79.4,0,0,0,82.65,44L56,38.65a8,8,0,0,0-8.23,2.44A79.8,79.8,0,0,0,24,96v16a80.09,80.09,0,0,0,80,80h16.27l10,23.36a15.75,15.75,0,0,0,14.54,9.64h.47a15.76,15.76,0,0,0,14.65-10.27l9-22.73H152a80.09,80.09,0,0,0,80-80ZM152,176H114.71a8,8,0,0,0-7.39,5l-9,22.75L88.29,180.4a8,8,0,0,0-7.37-4.4H80A64.07,64.07,0,0,1,40,112V96a64,64,0,0,1,18.06-44.5L82,46.7A64.05,64.05,0,0,1,128,48h0a64.05,64.05,0,0,1,46,1.3l23.94,4.8A64,64,0,0,1,216,96v16A64.07,64.07,0,0,1,152,176ZM148,84a12,12,0,1,1-12-12A12,12,0,0,1,148,84Zm40,0a12,12,0,1,1-12-12A12,12,0,0,1,188,84ZM88,116a8,8,0,0,1-8,8H72v8a8,8,0,0,1-16,0v-8H48a8,8,0,0,1,0-16h8V84a8,8,0,0,1,16,0v8h8A8,8,0,0,1,88,116Z"/>`,
	
	// 邮箱 (Email - TUM邮箱展示必备)
	envelope: `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M32 56h192a8 8 0 0 1 8 8v128a8 8 0 0 1-8 8H32a8 8 0 0 1-8-8V64a8 8 0 0 1 8-8Z"/><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="m224 56-96 88L32 56"/>`,

	// 微信 (WeChat)
	wechat: `<path fill="currentColor" stroke="none" transform="scale(0.85) translate(20, 20)" d="M86.4 49.3c-28.5 0-51.5 19-51.5 42.4 0 13.3 7 25.1 18 32.7l-4.7 14.8 17.6-8.8c6.3 1.8 13.2 2.8 20.4 2.8 28.5 0 51.5-19 51.5-42.4.1-23.5-22.9-42.5-51.3-42.5zm-15.3 32.4c-3.6 0-6.4-2.8-6.4-6.4s2.8-6.4 6.4-6.4 6.4 2.8 6.4 6.4-2.8 6.4-6.4 6.4zm30.7 0c-3.6 0-6.4-2.8-6.4-6.4s2.8-6.4 6.4-6.4 6.4 2.8 6.4 6.4-2.9 6.4-6.4 6.4zM167.6 112.5c-20.7 0-37.5 13.8-37.5 30.8 0 9.7 5.1 18.2 13 23.8l-3.4 10.7 12.8-6.4c4.6 1.3 9.6 2 14.9 2 20.7 0 37.5-13.8 37.5-30.8s-16.7-30.1-37.3-30.1zm-11.2 23.6c-2.6 0-4.7-2.1-4.7-4.7s2.1-4.7 4.7-4.7 4.7 2.1 4.7 4.7-2.1 4.7-4.7 4.7zm22.4 0c-2.6 0-4.7-2.1-4.7-4.7s2.1-4.7 4.7-4.7 4.7 2.1 4.7 4.7-2.1 4.7-4.7 4.7z"/>`,

	// 知乎 (Zhihu)
	zhihu: `<path fill="currentColor" stroke="none" transform="scale(0.85) translate(20, 20)" d="M170.5 119.5h-15.5V145h-16.1v-25.5h-20v-14.4h20V87.2c0-14.8 12-26.7 26.8-26.7h8.8v15.2h-8.8c-6.4 0-11.6 5.2-11.6 11.6v17.8h16.4v14.4zm-85.3-2.1h-24v-46h-15.1v46H23.5v14.6h22.7v24.1c0 8.4 6.8 15.2 15.2 15.2h10.9v-14.6H61.4c-.4 0-.8-.4-.8-.8v-23.9h24.6v-14.6z"/>`,

	// 微博 (Weibo)
	weibo: `<path fill="currentColor" stroke="none" transform="scale(0.9) translate(15, 15)" d="M213.5 124.6c-1.3-3.4-4-6.2-7.5-7.9-2.9-1.4-6.3-2-9.6-1.7-8.7 1.1-15 8.9-14.4 17.6.6 8.7 8 15.3 16.7 15.3.3 0 .7 0 1-.1 9.4-1.2 16.1-9.7 14.8-19.1-1-4.1-3.6-7.8-7.5-10.4 2-1.2 3.8-2.6 5.3-4.4 3-3.8 4.2-8.5 3.3-13.3-1.6-8.9-10.1-14.8-18.9-13.2-3.8.7-7.2 2.7-9.6 5.6-.9 1.1-1.6 2.3-2.2 3.6-1.5-6.8-6.4-12.4-13.3-14.9-6.4-2.3-13.7-1.4-19.3 2.5-11.5 8.1-14.2 23.9-6.1 35.4 6.4 9 17 14.3 28.3 14.3 15.7 0 29.3-10.3 33.6-25.3.8-2.6.4-5.3-.8-7.7z"/>`,

	// Bilibili (B站)
	bilibili: `<path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M80 64 64 40m112 24 16-24M56 64h144a16 16 0 0 1 16 16v96a16 16 0 0 1-16 16H56a16 16 0 0 1-16-16V80a16 16 0 0 1 16-16Z"/><circle cx="92" cy="120" r="12" fill="currentColor" stroke="none"/><circle cx="164" cy="120" r="12" fill="currentColor" stroke="none"/><path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="16" d="M104 152a28 28 0 0 0 48 0"/>`
};